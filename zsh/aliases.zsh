...
alias dotsync="dotgit pull && dotgit add -A && dotgit commit && dotgit push; echo 'You should run dotdrop install to update your dotfiles, it can take a lot of time :)'"
